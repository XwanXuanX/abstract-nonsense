...
void solve() {
    ...
    print(prefix1 + suffix0);
}

/**
 * obs:
 * 1. at last, you will end up with a single digit
 * 2. from the back, find the first non-zero digit
 * 3. remove all zero behind it, remove all non-zero in front of it
 * 4. done
 */

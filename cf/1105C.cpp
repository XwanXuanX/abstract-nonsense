...
// # of numbers that are a multiple of 3 in [0, n]
int div3_rem0(int n) {
    return (n / 3) + 1;
}
// # of numbers that mod 3 = 1 in [0, n]
int div3_rem1(int n) {
    int rem0 = div3_rem0(n);
    if (n % 3 == 0) {
        return rem0 - 1;
    } else {
        return rem0;
...
// # of numbers that mod 3 = 2 in [0, n]
int div3_rem2(int n) {
    int rem0 = div3_rem0(n);
    if (n % 3 == 0 || n % 3 == 1) {
        return rem0 - 1;
...
void solve() {
    int n, l, r; re(n, l, r);
    int rem0 = div3_rem0(r) - div3_rem0(l - 1);
    int rem1 = div3_rem1(r) - div3_rem1(l - 1);
    int rem2 = div3_rem2(r) - div3_rem2(l - 1);
    V<V<mint>> dp(n+1, V<mint>(3, 0));
    dp[0][0] = 1;
    for (int i = 1; i <= n; ++i) {
        dp[i][0] = dp[i-1][0] * rem0 + dp[i-1][1] * rem2 + dp[i-1][2] * rem1;
        dp[i][1] = dp[i-1][0] * rem1 + dp[i-1][1] * rem0 + dp[i-1][2] * rem2;
        dp[i][2] = dp[i-1][0] * rem2 + dp[i-1][1] * rem1 + dp[i-1][2] * rem0;
    }
    ps(dp[n][0]);
}
